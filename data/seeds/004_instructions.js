exports.seed = function(knex) {
  return knex('instructions').insert([
    ...
    {recipe_id: 1, instruction: 'Slowly add it in hot truffle oil and let it fry until golden brown'},
    ...
    {recipe_id: 2, instruction: 'Assemble the buns with the patty, 2 pieces of bacon, lettuce and tomatoes'},
    {recipe_id: 3, instruction: 'Bring enough water up to a boil'},
    {recipe_id: 3, instruction: 'Add the noodles and let it cook until it is al dante while occasionally stirring'},
    ...
    {recipe_id: 3, instruction: 'When the cheese is melted you are good to go!'},
  ]);
};